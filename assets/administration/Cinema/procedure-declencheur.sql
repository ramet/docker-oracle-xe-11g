...
revoke execute on ADMIN.INSER_1_RESA_OBLIG from ETD ;
drop public synonym INSER_1_RESA_OBLIG ;
drop procedure INSER_1_RESA_OBLIG ;

create procedure INSER_1_RESA_OBLIG ( 
...
create public synonym INSER_1_RESA_OBLIG for ADMIN.INSER_1_RESA_OBLIG ;

grant execute on ADMIN.INSER_1_RESA_OBLIG to ETD ;
...
drop public synonym AVANT_SUPPR_RESA_OBLIG ;
drop trigger AVANT_SUPPR_RESA_OBLIG ;

create trigger AVANT_SUPPR_RESA_OBLIG
...
create public synonym AVANT_SUPPR_RESA_OBLIG for ADMIN.AVANT_SUPPR_RESA_OBLIG ;

select TRIGGER_TYPE , TRIGGERING_EVENT , TABLE_NAME , DESCRIPTION , TRIGGER_BODY 
from ALL_TRIGGERS 
where TRIGGER_NAME = 'AVANT_SUPPR_RESA_OBLIG' ;
